...
const OnboardingStep2: FC<{ onBack: () => void; onNext: () => void }> = ({
  ...
  // Upstream's one-click links open Voholabs Studio's own marketplace listings, which
  // connect to their hosted server, not this instance. Ours are set up from
  // the Connect screen instead.
  const connector = null as { href: string; label: string } | null;
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'No MCP or CLI settings needed. Paste this into the chat, the agent installs the Voholabs CLI and asks you for your API key.'
          )}
        </div>
      </div>
        ...
        <div>
          ...
          <div className="text-[13px] text-customColor18 mt-[2px]">
            {t(
              ...
              'Use the Voholabs Studio API from your own code, n8n or any other automation'
            )}
          </div>
        </div>
        <a
      ...
      <div>
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'The fastest way: add Voholabs Studio with one click, you will be asked to sign in'
          )}
        </div>
      </div>
      <a
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'Give your agent Voholabs Studio tools to create, schedule and manage posts'
          )}
        </div>
      </div>
        ...
        <div className="flex flex-col gap-[6px]">
          ...
          <div className="flex gap-[6px]">
            {(['oauth', 'apikey'] as const).map((m) => (
              ...
              >
                {m === 'oauth'
                  ? t('sign_in_no_api_key', 'Sign in with Voholabs Studio (no API key)')
                  : t('api_key', 'API Key')}
              </button>
            ))}
          </div>
      ...
      <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder">
        ...
        <div className="text-[13px] text-customColor18 mt-[2px]">
          {t(
            ...
            'Install the Voholabs CLI and the skill that teaches your agent how to use it'
          )}
        </div>
      </div>
