...
Experience is your own notebook, not the user's instructions, so unlike the rest of the brief you may write here without asking permission first. Say afterwards what you noted.
